...
class SubmitProofArgs:
    ...
    def abi_method_signature(self) -> str:
        return "submit_proof(string,string,uint64,string)string"
...
class ZkpVaultParams:
    ...
    def submit_proof(
        self,
        args: tuple[str, str, int, str] | SubmitProofArgs,
        ...
        return self.app_client.params.call(algokit_utils.AppClientMethodCallParams(**{
            **dataclasses.asdict(params),
            "method": "submit_proof(string,string,uint64,string)string",
            "args": method_args,
        }))
...
class ZkpVaultClient:
    ...
    def decode_return_value(
        self,
        method: typing.Literal["submit_proof(string,string,uint64,string)string"],
...
class ZkpVaultMethodCallCreateParams(
    algokit_utils.AppClientCreateSchema, algokit_utils.BaseAppClientMethodCallParams[
        typing.Any,
        str | None,
    ]
):
    """Parameters for creating ZkpVault contract using ABI"""
...
class ZkpVaultFactory(algokit_utils.TypedAppFactoryProtocol[ZkpVaultMethodCallCreateParams, None, None]):
    """Factory for deploying and managing ZkpVaultClient smart contracts"""
    ...
    def __init__(
        ...
        *,
        ...
        self.params = ZkpVaultFactoryParams(self.app_factory)
        self.create_transaction = ZkpVaultFactoryCreateTransaction(self.app_factory)
        self.send = ZkpVaultFactorySend(self.app_factory)
    ...
    def deploy(
        ...
        *,
        ...
        create_params: ZkpVaultMethodCallCreateParams | None = None,
        ...
        compilation_params: algokit_utils.AppClientCompilationParams | None = None,
        send_params: algokit_utils.SendParams | None = None,
    ) -> tuple[ZkpVaultClient, algokit_utils.AppFactoryDeployResult]:
        ...
        return ZkpVaultClient(deploy_response[0]), deploy_response[1]
...
class ZkpVaultFactoryParams:
    """Parameters for creating transactions for ZkpVault contract"""

    def __init__(self, app_factory: algokit_utils.AppFactory):
        self.app_factory = app_factory
        self.create = ZkpVaultFactoryCreateParams(app_factory)
        self.update = ZkpVaultFactoryUpdateParams(app_factory)
        self.delete = ZkpVaultFactoryDeleteParams(app_factory)

class ZkpVaultFactoryCreateParams:
    """Parameters for 'create' operations of ZkpVault contract"""
    ...
    def submit_proof(
        ...
        *,
        ...
        """Creates a new instance using the submit_proof(string,string,uint64,string)string ABI method"""
        params = params or algokit_utils.CommonAppCallCreateParams()
    ...
    def verify_submission(
        ...
        *,
        ...
        """Creates a new instance using the verify_submission(string,string,uint64,string)bool ABI method"""
        params = params or algokit_utils.CommonAppCallCreateParams()
        return self.app_factory.params.create(
            algokit_utils.AppFactoryCreateMethodCallParams(
                **{
...
class ZkpVaultFactoryUpdateParams:
    """Parameters for 'update' operations of ZkpVault contract"""
...
class ZkpVaultFactoryDeleteParams:
    """Parameters for 'delete' operations of ZkpVault contract"""
...
class ZkpVaultFactoryCreateTransaction:
    """Create transactions for ZkpVault contract"""

    def __init__(self, app_factory: algokit_utils.AppFactory):
        self.app_factory = app_factory
        self.create = ZkpVaultFactoryCreateTransactionCreate(app_factory)


class ZkpVaultFactoryCreateTransactionCreate:
    """Create new instances of ZkpVault contract"""
...
class ZkpVaultFactorySend:
    """Send calls to ZkpVault contract"""

    def __init__(self, app_factory: algokit_utils.AppFactory):
        self.app_factory = app_factory
        self.create = ZkpVaultFactorySendCreate(app_factory)


class ZkpVaultFactorySendCreate:
    """Send create calls to ZkpVault contract"""
    ...
    def bare(
        ...
        *,
        ...
        send_params: algokit_utils.SendParams | None = None,
        compilation_params: algokit_utils.AppClientCompilationParams | None = None,
    ) -> tuple[ZkpVaultClient, algokit_utils.SendAppCreateTransactionResult]:
        """Creates a new instance using a bare call"""
        params = params or algokit_utils.CommonAppCallCreateParams()
        ...
        return ZkpVaultClient(result[0]), result[1]
    ...
    def create_application(
        ...
        *,
        ...
        send_params: algokit_utils.SendParams | None = None,
        compilation_params: algokit_utils.AppClientCompilationParams | None = None
    ) -> tuple[ZkpVaultClient, algokit_utils.AppFactoryCreateMethodCallResult[None]]:
            ...
            return ZkpVaultClient(client), algokit_utils.AppFactoryCreateMethodCallResult[None](
                **{
                    **result.__dict__,
    ...
    def submit_proof(
        ...
        self._result_mappers.append(
            lambda v: self.client.decode_return_value(
                "submit_proof(string,string,uint64,string)string", v
            )
        )
        return self
